...
public class Fragment3 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
           ...
           View myView = inflater.inflate(R.layout.pic3, container, false);
           Button myButton = (Button) myView.findViewById(R.id.button3);
           context = getActivity().getApplicationContext();

           name = (TextView) myView.findViewById(R.id.textView6);
           party = (TextView) myView.findViewById(R.id.textView7);
