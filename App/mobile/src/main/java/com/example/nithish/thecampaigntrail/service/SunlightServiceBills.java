 ...
 */
public class SunlightServiceBills {

    private SunlightServiceCallback callback;
    private String bioguide;
    private Exception error;

    public SunlightServiceBills(SunlightServiceCallback callback) {
    ...
    public void refreshReps (final String bioguide){
        new AsyncTask<String, Void, String>() {
            ...
            protected String doInBackground(String... params) {
                ...
                String endpoint = String.format("http://congress.api.sunlightfoundation.com/bills?sponsor_id=%s&apikey=7d7a7dd29e104eadaf3481fdf3535344", Uri.encode(YQL));
            ...
            protected void onPostExecute(String s) {
                ...
                try {
                    ...
                    BillResults newResult = new BillResults();
                    newResult.populate(apiResults);

                    callback.serviceSuccessBill(newResult);
